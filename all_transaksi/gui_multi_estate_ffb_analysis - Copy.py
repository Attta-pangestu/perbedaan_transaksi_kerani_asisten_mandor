    ...
    def create_pdf_report(self, all_results, start_date, end_date):
        try:
            ...
            company_header = Paragraph(
                "<b>PT. PERKEBUNAN NUSANTARA IV</b><br/>SISTEM MONITORING TRANSAKSI FFB", 
                header_style
            )
            ...
            # Enhanced Header with Icons and Better Formatting
            header = [
                '🏢 ESTATE', '📍 DIVISI', '👤 KARYAWAN', '🎯 ROLE', 
                '📊 JUMLAH\nTRANSAKSI', '✅ PERSENTASE\nTERVERIFIKASI', '⚠️ KETERANGAN\nPERBEDAAN'
            ]
            ...
            # Create table with custom column widths for better layout
            col_widths = [80, 80, 120, 60, 70, 90, 100]  # Optimized column widths
            ...
            style = TableStyle([
                ...
                ('LINEBELOW', (0, 0), (-1, 0), 2, colors.HexColor('#2C5282')),  # Header underline
            ...
            for i, row in enumerate(table_data):
                ...
                elif len(row) > 3 and row[3] == 'KERANI':
                ...
                elif len(row) > 3 and row[3] == 'MANDOR':
                ...
                elif len(row) > 3 and row[3] == 'ASISTEN':
            ...
            explanations = [
                "<b>🔴 KERANI:</b> Persentase transaksi yang sudah diverifikasi (ada duplikat TRANSNO dengan P1/P5) dari total yang dibuat. Angka dalam kurung menunjukkan jumlah transaksi terverifikasi.",
                "<b>🟢 MANDOR:</b> Persentase transaksi verifikasi yang dilakukan per total Kerani di divisi. Semakin tinggi persentase, semakin baik kinerja verifikasi.",
                "<b>🔵 ASISTEN:</b> Persentase transaksi verifikasi yang dilakukan per total Kerani di divisi. Menunjukkan kontribusi asisten dalam proses verifikasi.",
                "<b>📊 SUMMARY:</b> Persentase verifikasi keseluruhan divisi (Total Transaksi Asisten+Mandor / Total Transaksi Kerani). Angka dalam kurung menunjukkan total verifikator.",
                "<b>🎯 GRAND TOTAL:</b> Persentase verifikasi keseluruhan untuk semua estate (Total Semua Asisten+Mandor / Total Semua Transaksi Kerani)."
            ]
            ...
            differences_explanations = [
                "<b>Metodologi:</b> Untuk setiap transaksi KERANI yang terverifikasi, sistem melakukan perbandingan field-by-field dengan input MANDOR/ASISTEN.",
                "<b>Field Perbandingan:</b> RIPEBCH, UNRIPEBCH, BLACKBCH, ROTTENBCH, LONGSTALKBCH, RATDMGBCH, LOOSEFRUIT.",
                "<b>Format Hasil:</b> 'X perbedaan (Y%)' dimana Y% = (X perbedaan / Jumlah transaksi terverifikasi) × 100.",
                "<b>Interpretasi:</b> Semakin sedikit perbedaan, semakin baik akurasi dan kinerja input data KERANI. Target ideal: < 5% perbedaan."
            ]
            ...
            🔄 Sistem Analisis Real-time | 🏢 PT. Perkebunan Nusantara IV"""
